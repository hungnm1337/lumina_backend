...
namespace Lumina.Tests
{
    public class DeleteArticleTests
    {
        ...
        [Fact]
        public async Task DeleteArticle_AsStaffWithOwnArticle_ShouldReturn204NoContent()
        {
            // Arrange
            var userId = 1;
            var articleId = 1;
            ...
            _mockArticleService.Setup(s => s.DeleteArticleAsync(articleId)).ReturnsAsync(true);
        ...
        [Fact]
        public async Task DeleteArticle_WithUserNotFound_ShouldReturn401Unauthorized()
        {
            // Arrange
            var userId = 1;
            var articleId = 1;
        ...
        [Fact]
        public async Task DeleteArticle_AsStaffWithOtherUserArticle_ShouldReturn403Forbid()
        {
            // Arrange
            var userId = 1;
            var articleId = 1;
            ...
            _mockArticleService.Verify(s => s.DeleteArticleAsync(It.IsAny<int>()), Times.Never);
        }
        ...
        [Fact]
        public async Task DeleteArticle_AsManager_CanDeleteAnyArticle_ShouldReturn204NoContent()
        {
            // Arrange
            var userId = 2;
            var articleId = 1;
        ...
        [Fact]
        public async Task DeleteArticle_WithNonExistentArticle_ShouldReturn404NotFound()
        {
            // Arrange
            var userId = 1;
            var articleId = 999;
        ...
        public async Task DeleteArticle_WhenServiceReturnsFalse_ShouldReturn404NotFound()
        {
            ...
            _mockUserRepository.Setup(r => r.GetUserByIdAsync(userId)).ReturnsAsync(staffUser);
            _mockArticleRepository.Setup(r => r.FindByIdAsync(articleId)).ReturnsAsync(article);
            _mockArticleService.Setup(s => s.DeleteArticleAsync(articleId)).ReturnsAsync(false);
