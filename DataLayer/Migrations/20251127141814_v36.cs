        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreakFreezesAvailable = table.Column<int>(type: "int", nullable: true),
                    MonthlyReadingAttempts = table.Column<int>(type: "int", nullable: false),
                    MonthlyListeningAttempts = table.Column<int>(type: "int", nullable: false),
                    LastQuotaReset = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateAt = table.Column<DateTime>(type: "datetime2(3)", precision: 3, nullable: true),
                    ExamSetKey = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedTOEICScore = table.Column<int>(type: "int", nullable: true),
                    FirstAttemptDate = table.Column<DateTime>(type: "datetime", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserNotification_Users",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<int>(type: "int", nullable: false),
                    ExamID = table.Column<int>(type: "int", nullable: false),
                    ExamPartId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamAttempts_ExamParts_ExamPartId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastQuizScore = table.Column<int>(type: "int", nullable: true),
                    LastQuizCompletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TotalQuizAttempts = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "UserAnswerSpeaking",
                columns: table => new
                {
                    UserAnswerSpeakingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AttemptID = table.Column<int>(type: "int", nullable: false),
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    Transcript = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PronunciationScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    AccuracyScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    FluencyScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    CompletenessScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    GrammarScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    VocabularyScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    ContentScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAnswerSpeaking", x => x.UserAnswerSpeakingId);
                    table.ForeignKey(
                        name: "FK_UserAnswerSpeaking_ExamAttempts_AttemptID",
                        column: x => x.AttemptID,
                        principalTable: "ExamAttempts",
                        principalColumn: "AttemptID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAnswerSpeaking_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "QuestionId");
                });
            ...
            migrationBuilder.CreateTable(
                name: "UserAnswerWriting",
                columns: table => new
                {
                    UserAnswerWritingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AttemptID = table.Column<int>(type: "int", nullable: false),
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    UserAnswerContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FeedbackFromAI = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAnswerWriting", x => x.UserAnswerWritingId);
                    table.ForeignKey(
                        name: "FK_UserAnswerWriting_ExamAttempts_AttemptID",
                        column: x => x.AttemptID,
                        principalTable: "ExamAttempts",
                        principalColumn: "AttemptID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAnswerWriting_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "QuestionId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAnswerMultipleChoice", x => x.UserAnswerID);
                    table.ForeignKey(
                        name: "FK_UserAnswerMultipleChoice_ExamAttempts_AttemptID",
                        column: x => x.AttemptID,
                        principalTable: "ExamAttempts",
                        principalColumn: "AttemptID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAnswerMultipleChoice_Options_SelectedOptionId",
                        column: x => x.SelectedOptionId,
                        principalTable: "Options",
                        principalColumn: "OptionId");
                    table.ForeignKey(
                        name: "FK_UserAnswerMultipleChoice_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "QuestionId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamAttempts_ExamPartId",
                table: "ExamAttempts",
                column: "ExamPartId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAnswerMultipleChoice_AttemptID",
                table: "UserAnswerMultipleChoice",
                column: "AttemptID");

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswerMultipleChoice_QuestionId",
                table: "UserAnswerMultipleChoice",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswerMultipleChoice_SelectedOptionId",
                table: "UserAnswerMultipleChoice",
                column: "SelectedOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswerSpeaking_AttemptID_QuestionId_Unique",
                table: "UserAnswerSpeaking",
                columns: new[] { "AttemptID", "QuestionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswerSpeaking_QuestionId",
                table: "UserAnswerSpeaking",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswerWriting_AttemptID",
                table: "UserAnswerWriting",
                column: "AttemptID");

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswerWriting_QuestionId",
                table: "UserAnswerWriting",
                column: "QuestionId");
